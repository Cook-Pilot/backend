...
a, r = assign([src("1", "새우 두부 계란찜", "반찬", "찌기")], [db("r1", "새우 두부 계란찜")])
ok &= check("두 축 모두 매핑된다", tags_of(a, "r1") == {"DISH_SIDE", "METHOD_STEAM"})

# 2. '기타'는 미부여. 다른 축은 살아남는다.
a, r = assign([src("2", "방울토마토 소박이", "반찬", "기타")], [db("r2", "방울토마토 소박이")])
